...
<body>
   <table width="100%" cellSpacing=0 cellPadding=0 border="0px">
	...
	<table class="query_form_table" cellSpacing=1 cellPadding=1>
		<tr>
			<td width=100% height=30 align=left
				background="images/m_table_top.jpg" colspan="6"><strong>&nbsp;用户信息>修改 </strong></td>
		</tr>
	...
	<table id="tb1" class="data_list_table" cellSpacing=1 cellPadding=1
		...
		<tr>
		    <td>用户ID(不可修改)</td>
		    <td><input readonly placeholder="${user.user_id }" /></td>
		</tr>
		<tr>
		    <td>用户类型(不可修改)</td>
		    <td><input readonly placeholder="${user.user_type }" /></td>
		</tr>
		<tr>
		    <td colspan="2"></td>
		</tr>
		...
		<tr>
		    <td>积分(不可修改)</td>
		    <td><input readonly placeholder="${user.bonus_points }" /></td>
		</tr>
		<tr>
		    <td colspan="2"></td>
		</tr>
		<tr>
		    <td>评论路径(不可修改)</td>
		    <td><input readonly placeholder="${user.commentpath }" /></td>
		</tr>
		<tr>
		    <td>其他</td>
